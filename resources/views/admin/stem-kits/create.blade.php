...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Add New STEM Kit</h1>
                <p class="text-muted mt-1 mb-0">Create a new learning kit</p>
            </div>
        ...
        <form action="{{ route('admin.stem-kits.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body p-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="category" id="category"
                                       ...
                                       value="{{ old('category') }}" placeholder="e.g. Robotics, Electronics">
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="difficulty_level" id="difficulty_level"
                                    ...
                                    @foreach(['easy', 'medium', 'hard'] as $level)
                                        <option value="{{ $level }}" {{ old('difficulty_level') == $level ? 'selected' : '' }}>{{ ucfirst($level) }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-check form-switch mb-3">
                                ...
                                <label class="form-check-label fw-semibold" for="is_available">Available for purchase</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary flex-fill">
                            <i class="bi bi-check-circle me-1"></i> Create Kit
                        </button>
