    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mt-1 mb-0">Broadcast an announcement to users</p>
            </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="priority" id="priority" class="form-select">
                                @foreach(['low', 'medium', 'high'] as $p)
                                    <option value="{{ $p }}" {{ old('priority', 'low') == $p ? 'selected' : '' }}>{{ ucfirst($p) }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label fw-semibold" for="is_global">Global announcement (visible to all users)</label>
                            </div>
                        </div>
