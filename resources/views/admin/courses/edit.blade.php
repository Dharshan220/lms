    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mt-1 mb-0">Update course details</p>
            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="short_description" id="short_description"
                                           ...
                                           value="{{ old('short_description', $course->short_description) }}" maxlength="255">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="school_id" id="school_id"
                                    ...
                                    @foreach($schools ?? [] as $school)
                                        <option value="{{ $school->id }}" {{ old('school_id', $course->school_id) == $school->id ? 'selected' : '' }}>
                                            {{ $school->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="duration_hours" id="duration_hours"
                                       ...
                                       value="{{ old('duration_hours', $course->duration_hours) }}" step="0.5" min="0">
