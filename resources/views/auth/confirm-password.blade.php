...
@section('title', 'Confirm Password - Nano Spark LMS')
...
<div class="ns-auth-wrapper">
    <div class="ns-auth-card">
        ...
        <p class="ns-subtitle">This is a secure area of the application. Please confirm your password before continuing.</p>
