...
<style>
    ...
    .ns-auth-card h2 {
        font-family: 'Poppins', 'Inter', sans-serif;
        font-size: 30px; font-weight: 700; color: #FFFFFF; margin-bottom: 8px;
    ...
    .ns-auth-link-row a { font-size: 13px; color: #FFC107; text-decoration: none; font-weight: 500; }
    ...
    .ns-auth-right .floating-dots span {
        ...
        background: rgba(255, 193, 7, 0.2); border-radius: 50%;
    ...
    <div class="ns-auth-left">
        <div class="ns-auth-card" style="background: rgba(28, 28, 28, 0.7); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); border: 1px solid rgba(255, 255, 255, 0.06); border-radius: 20px; padding: 40px;">
            ...
            <div class="ns-auth-divider" style="display:flex; align-items:center; gap:16px; margin:24px 0;">
                ...
                <span style="font-size:13px; color:#888888; font-weight:500;">or continue with</span>
                <div style="flex:1; height:1px; background: rgba(255,255,255,0.06);"></div>
            </div>

            <div style="display:flex; gap:12px;">
                <a href="{{ route('auth.google.redirect') }}" class="ns-hover-border" style="flex:1; display:flex; align-items:center; justify-content:center; gap:8px; padding:12px; border-radius:12px; border:1px solid rgba(255,255,255,0.06); background:rgba(255,255,255,0.03); color:#CFCFCF; cursor:pointer; transition:all 0.2s; font-family:'Inter',sans-serif; font-size:13px; font-weight:600; text-decoration:none;">
                    <i class="bi bi-google"></i> Google
                </a>
                <button type="button" class="ns-hover-border" style="flex:1; display:flex; align-items:center; justify-content:center; gap:8px; padding:12px; border-radius:12px; border:1px solid rgba(255,255,255,0.06); background:rgba(255,255,255,0.03); color:#CFCFCF; cursor:pointer; transition:all 0.2s; font-family:'Inter',sans-serif; font-size:13px; font-weight:600;">
