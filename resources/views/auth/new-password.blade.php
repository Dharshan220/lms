...
@section('title', 'Set New Password - Nano Spark LMS')
...
<div class="ns-auth-wrapper">
    <div class="ns-auth-card">
        ...
        <p class="ns-subtitle">Choose a strong password for your account.</p>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="ns-form-group">
                ...
                <input id="password" type="password" name="password" required autocomplete="new-password" class="ns-form-control" placeholder="Enter new password" minlength="8">
...
<script>
    document.getElementById('password')?.addEventListener('input', function () {
        ...
        if (score < 30) bar.style.background = '#EF4444';
